...
export function ThreeTimeline() {
  return (
    <section id="timeline" className="py-24 bg-background relative overflow-hidden border-y border-primary/5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {stats.map((stat, index) => (
            <div 
              ...
              className="group relative glass-morphism p-10 rounded-[2rem] border-white/5 bg-[#0d0d14]/40 hover:bg-[#12121c]/60 hover:border-primary/30 transition-all duration-500 text-center flex flex-col items-center justify-center min-h-[280px] animate-in fade-in slide-in-from-bottom-12 duration-1000 fill-mode-both"
            >
              {/* Icon Container */}
