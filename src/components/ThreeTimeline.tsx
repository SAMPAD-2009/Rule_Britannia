      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {stats.map((stat) => (
            <div 
              key={stat.id}
              className="group relative glass-morphism p-10 rounded-[2rem] border-white/5 bg-[#0d0d14]/40 hover:bg-[#12121c]/60 hover:border-primary/30 transition-all duration-500 text-center flex flex-col items-center justify-center min-h-[280px]"
            >
              {/* Icon Container */}
